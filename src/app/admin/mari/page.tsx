      ...
      <div className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Seção Mari Carreira</h1>
              <p className="text-gray-500 mt-1 text-sm sm:text-base">Gerenciar informações da Mari na homepage</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-lg p-6">
                      ...
                      <div className="relative aspect-[9/19.5] bg-white rounded-[36px] overflow-hidden">
                        {displayImage ? (
                            ...
                            {previewVideo && (
                              <div className="absolute inset-0 flex items-center justify-center">
                                <div className="bg-white/90 backdrop-blur-sm rounded-full p-4 shadow-xl">
                                  <Play className="w-10 h-10 text-[#C2227A] fill-[#C2227A]" />
                                </div>
                              </div>
                            )}
                          </>
                          ...
                          <div className="w-full h-full flex items-center justify-center bg-gradient-to-b from-[#C2227A]/10 to-[#C2227A]/20">
                            <div className="flex h-[100px] w-[100px] items-center justify-center rounded-full bg-gradient-to-br from-[#C2227A] to-pink-700 text-4xl font-light text-white">
                              MC
                            </div>
                          </div>
                        )}
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  <div className="bg-white/80 backdrop-blur-sm p-3 rounded-lg text-center border border-pink-100">
                    <div className="text-xl font-bold text-[#C2227A]">+{formData.followers_count.toLocaleString('pt-BR')}</div>
                    <p className="text-[10px] font-bold uppercase text-gray-600 mt-1">{formData.followers_label}</p>
                  </div>
                  <div className="bg-white/80 backdrop-blur-sm p-3 rounded-lg text-center border border-pink-100">
                    <div className="text-xl font-bold text-[#C2227A]">{formData.partners_count}</div>
                    <p className="text-[10px] font-bold uppercase text-gray-600 mt-1">{formData.partners_label}</p>
                  </div>
                  <div className="bg-white/80 backdrop-blur-sm p-3 rounded-lg text-center border border-pink-100">
                    <div className="text-xl font-bold text-[#C2227A]">{formData.active_since}</div>
                    <p className="text-[10px] font-bold uppercase text-gray-600 mt-1">{formData.active_since_label}</p>
                  </div>
                </div>

                {/* Descrição Preview */}
                {formData.description && (
                  <div className="bg-white/80 backdrop-blur-sm p-3 rounded-lg border border-pink-100">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <label className="flex-1 cursor-pointer">
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-[#C2227A] transition-colors text-center">
                        {uploadingPhoto ? (
                          <div className="flex items-center justify-center gap-2">
                            <span className="animate-spin h-5 w-5 border-2 border-[#C2227A] border-t-transparent rounded-full"></span>
                      ...
                      {!previewThumbnail && (
                        <div className="mt-3">
                          <label className="cursor-pointer">
                            <div className="border-2 border-dashed border-orange-300 rounded-lg p-3 hover:border-orange-500 transition-colors text-center bg-orange-50">
                              {uploadingThumbnail ? (
                                <div className="flex items-center justify-center gap-2">
                                  <span className="animate-spin h-4 w-4 border-2 border-orange-600 border-t-transparent rounded-full"></span>
                                  <span className="text-sm text-orange-600">Enviando capa...</span>
                                </div>
                              ) : (
                                <div className="flex items-center justify-center gap-2 text-sm text-orange-600">
                                  <Upload size={16} />
                                  Adicionar Capa/Thumbnail *
                                </div>
                              )}
                            </div>
                            <input 
                          ...
                          <p className="text-xs text-orange-600 mt-1">⚠️ Capa obrigatória para vídeos</p>
                        </div>
                      )}
                      {previewThumbnail && (
                        <div className="mt-2">
                          <p className="text-xs text-green-600">✓ Capa carregada</p>
                        </div>
                      )}
                    </div>
                  ) : (
                    <label className="cursor-pointer">
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-[#C2227A] transition-colors text-center">
                        {uploadingVideo ? (
                          <div className="flex items-center justify-center gap-2">
                            <span className="animate-spin h-5 w-5 border-2 border-[#C2227A] border-t-transparent rounded-full"></span>
                            <span className="text-sm text-gray-600">Enviando vídeo...</span>
                          </div>
                        ) : (
                          <div className="flex items-center justify-center gap-2 text-sm text-gray-600">
                            <VideoIcon size={20} />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#C2227A] focus:border-transparent"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div className="border-t pt-4">
                  <h3 className="text-sm font-medium text-gray-900 mb-3">Textos dos Cards</h3>
                  <div className="space-y-3">
                    <div>
                      ...
                      <input 
                        ...
                        placeholder="Ex: Seguidores, Inscritos"
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#C2227A] focus:border-transparent"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-medium text-gray-700 mb-1">
                      ...
                      <input 
                        ...
                        placeholder="Ex: Parceiros, Empresas Parceiras"
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#C2227A] focus:border-transparent"
                      />
                    </div>
                    <div>
                      ...
                      <input 
                        ...
                        placeholder="Ex: Desde, Ativo desde"
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#C2227A] focus:border-transparent"
                      />
                    </div>
                  </div>
                ...
                <button 
                  ...
                  className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-[#C2227A] text-white rounded-lg hover:bg-[#A01860] disabled:opacity-50 font-semibold"
                >
                  {saving ? (
                    <>
